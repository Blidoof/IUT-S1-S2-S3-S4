...
{
	this->fenetrePrincipale = (Principale*) parent; //On lie la fenetre enfant à la fenetre principale (passée en paramètre (parent) lors de l'instanciation de la fenetre enfant)
	...
	ancienNom = this->fenetrePrincipale->getNomJ1(); //On recupère le nom actuel du joueur 1 qu'on met dans ancienNom pour le passer en paramètres lors de la création du label labelNomJ1
