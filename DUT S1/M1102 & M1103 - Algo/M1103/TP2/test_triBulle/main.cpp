...
//    int monTab [TAILLE] = {8, 8, 8, 8, 8, 8, 8, 8, 8, 8}; //trié (constant)
    ...
    UnePersonne monAgenda[TAILLE] =
    {
        ...
        {"Alami", "Chakib", {41, "allee de la patisserie",64250, "Itxassou"}, 3},
    ...
    */
	...
	/* Objectifs du test du tri Bulle sur le tableau de personnes :
       (a) tester le tri_Bulle selon le critère de NOM
       (b) tester le tri Bulle selon le critère de VILLE
       (c) déterminer si le tri Bulle est STABLE ou pas :
           Pour cette vérification, le programme appliquera le test (b) au tableau résultant du test (a).
           On vérifiera manuellement que les personnes habitant une même VILLE restent triées par ordre alphabétique sur le NOM.
    */
